...
namespace ImGui
{
    ...
    IMGUI_API ImGuiID       GetEntityID(const char* str_id);                                      // calculate unique ID (hash of whole ID stack + given parameter). e.g. if you want to query into ImGuiStorage yourself
    IMGUI_API ImGuiID       GetEntityID(const char* str_id_begin, const char* str_id_end);
    IMGUI_API ImGuiID       GetEntityID(const void* ptr_id);
